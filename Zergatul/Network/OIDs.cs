...
// ********************************************************************
// SHA256         OIDs.xml: 72987C7A7EB891E676AB92A9265B2F53E11A150AA04B8822A1AACE6843EEDD75
    ...
    public partial class OID
    {
        ...
        public static class ISO
        {
                    ...
                    public static class ANSI_X962
                    {
                        ...
                        public static class Curves
                        {
                            ...
                            public static class Char2
                            {
                                ...
                                public static OID c2pnb176v1 = new OID("1.2.840.10045.3.0.4", "c2pnb176v1");
            ...
            public static class IdentifiedOrganization
            {
                ...
                public static class Teletrust
                {
                    ...
                    public static class Algorithm
                    {
                        ...
                        public static class SignatureAlgorithm
                        {
                            ...
                            /// 1.3.36.3.3.2
                            /// </summary>
                            public static class ECSign
                            {
                                /// <summary>
                                /// 1.3.36.3.3.2.8
                                /// </summary>
                                public static class ECStdCurvesAndGeneration
                                {
                                    /// <summary>
                                    /// 1.3.36.3.3.2.8.1
                                    /// </summary>
                                    public static class EllipticCurve
                                    {
                                        ...
                                        {
                                            public static OID brainpoolP160r1 = new OID("1.3.36.3.3.2.8.1.1.1", "brainpoolP160r1");
                                            public static OID brainpoolP160t1 = new OID("1.3.36.3.3.2.8.1.1.2", "brainpoolP160t1");
                                            public static OID brainpoolP192r1 = new OID("1.3.36.3.3.2.8.1.1.3", "brainpoolP192r1");
                                            public static OID brainpoolP192t1 = new OID("1.3.36.3.3.2.8.1.1.4", "brainpoolP192t1");
                                            public static OID brainpoolP224r1 = new OID("1.3.36.3.3.2.8.1.1.5", "brainpoolP224r1");
                                            public static OID brainpoolP224t1 = new OID("1.3.36.3.3.2.8.1.1.6", "brainpoolP224t1");
                                            public static OID brainpoolP256r1 = new OID("1.3.36.3.3.2.8.1.1.7", "brainpoolP256r1");
                                            public static OID brainpoolP256t1 = new OID("1.3.36.3.3.2.8.1.1.8", "brainpoolP256t1");
                                            public static OID brainpoolP320r1 = new OID("1.3.36.3.3.2.8.1.1.9", "brainpoolP320r1");
                                            public static OID brainpoolP320t1 = new OID("1.3.36.3.3.2.8.1.1.10", "brainpoolP320t1");
                                            public static OID brainpoolP384r1 = new OID("1.3.36.3.3.2.8.1.1.11", "brainpoolP384r1");
                                            public static OID brainpoolP384t1 = new OID("1.3.36.3.3.2.8.1.1.12", "brainpoolP384t1");
                                            public static OID brainpoolP512r1 = new OID("1.3.36.3.3.2.8.1.1.13", "brainpoolP512r1");
                                            public static OID brainpoolP512t1 = new OID("1.3.36.3.3.2.8.1.1.14", "brainpoolP512t1");
                                        ...
                                        public static IEnumerable<OID> All => (VersionOne.All);
                                    }

                                    public static IEnumerable<OID> All => (EllipticCurve.All);
                                }

                                public static IEnumerable<OID> All => (ECStdCurvesAndGeneration.All);
                            }

                            public static IEnumerable<OID> All => (ECSign.All);
                        }

                        public static IEnumerable<OID> All => (SignatureAlgorithm.All);
                    }

                    public static IEnumerable<OID> All => (Algorithm.All);
                }
                ...
                public static IEnumerable<OID> All => (DOD.All).Concat(OIW.All).Concat(Teletrust.All).Concat(Certicom.All);
            }
