...
namespace Zergatul.Cryptography.Tests.BlockCipher
{
    ...
    public class RC4Tests
    {
        ...
        public void RC4_Vector1()
        {
            Test("0102030405",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "69 82 94 4f  18 fc 82 d5   89 c4 03 a4  7a 0d 09 19",
                    [0240] = "28 cb 11 32  c9 6c e2 86   42 1d ca ad  b8 b6 9e ae",
                    [0256] = "1c fc f6 2b  03 ed db 64   1d 77 df cf  7f 8d 8c 93",
                    [0496] = "42 b7 d0 cd  d9 18 a8 a3   3d d5 17 81  c8 1f 40 41",
                    [0512] = "64 59 84 44  32 a7 da 92   3c fb 3e b4  98 06 61 f6",
                    [0752] = "ec 10 32 7b  de 2b ee fd   18 f9 27 76  80 45 7e 22",
                    [0768] = "eb 62 63 8d  4f 0b a1 fe   9f ca 20 e0  5b f8 ff 2b",
        ...
        public void RC4_Vector2()
        {
            Test("01020304050607",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "e6 20 f1 39  0d 19 bd 84   e2 e0 fd 75  20 31 af c1",
                    [0240] = "91 4f 02 53  1c 92 18 81   0d f6 0f 67  e3 38 15 4c",
                    [0256] = "d0 fd b5 83  07 3c e8 5a   b8 39 17 74  0e c0 11 d5",
                    [0496] = "75 f8 14 11  e8 71 cf fa   70 b9 0c 74  c5 92 e4 54",
                    [0512] = "0b b8 72 02  93 8d ad 60   9e 87 a5 a1  b0 79 e5 e4",
                    [0752] = "c2 91 12 46  b6 12 e7 e7   b9 03 df ed  a1 da d8 66",
                    [0768] = "32 82 8f 91  50 2b 62 91   36 8d e8 08  1d e3 6f c2",
        ...
        public void RC4_Vector3()
        {
            Test("0102030405060708",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "82 63 ef db  45 c4 a1 86   84 ef 87 e6  b1 9e 5b 09",
                    [0240] = "96 36 eb c9  84 19 26 f4   f7 d1 f3 62  bd df 6e 18",
                    [0256] = "d0 a9 90 ff  2c 05 fe f5   b9 03 73 c9  ff 4b 87 0a",
                    [0496] = "73 23 9f 1d  b7 f4 1d 80   b6 43 c0 c5  25 18 ec 63",
                    [0512] = "16 3b 31 99  23 a6 bd b4   52 7c 62 61  26 70 3c 0f",
                    [0752] = "49 d6 c8 af  0f 97 14 4a   87 df 21 d9  14 72 f9 66",
                    [0768] = "44 17 3a 10  3b 66 16 c5   d5 ad 1c ee  40 c8 63 d0",
        ...
        public void RC4_Vector4()
        {
            Test("0102030405060708090a",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "03 51 6b a7  8f 41 3b eb   22 3a a5 d4  d2 df 67 11",
                    [0240] = "3c fd 6c b5  8e e0 fd de   64 01 76 ad  00 00 04 4d",
                    [0256] = "48 53 2b 21  fb 60 79 c9   11 4c 0f fd  9c 04 a1 ad",
                    [0496] = "3e 8c ea 98  01 71 09 97   90 84 b1 ef  92 f9 9d 86",
                    [0512] = "e2 0f b4 9b  db 33 7e e4   8b 8d 8d c0  f4 af ef fe",
                    [0752] = "5c 25 21 ea  cd 79 66 f1   5e 05 65 44  be a0 d3 15",
                    [0768] = "e0 67 a7 03  19 31 a2 46   a6 c3 87 5d  2f 67 8a cb",
        ...
        public void RC4_Vector5()
        {
            Test("0102030405060708090a0b0c0d0e0f10",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "52 48 c4 95  90 14 12 6a   6e 8a 84 f1  1d 1a 9e 1c",
                    [0240] = "06 59 02 e4  b6 20 f6 cc   36 c8 58 9f  66 43 2f 2b",
                    [0256] = "d3 9d 56 6b  c6 bc e3 01   07 68 15 15  49 f3 87 3f",
                    [0496] = "b6 d1 e6 c4  a5 e4 77 1c   ad 79 53 8d  f2 95 fb 11",
                    [0512] = "c6 8c 1d 5c  55 9a 97 41   23 df 1d bc  52 a4 3b 89",
                    [0752] = "c5 ec f8 8d  e8 97 fd 57   fe d3 01 70  1b 82 a2 59",
                    [0768] = "ec cb e1 3d  e1 fc c9 1c   11 a0 b2 6c  0b c8 fa 4d",
        ...
        public void RC4_Vector6()
        {
            Test("0102030405060708090a0b0c0d0e0f101112131415161718",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "df de 31 34  4a 1a f7 69   c7 4f 07 0a  ee 9e 23 26",
                    [0240] = "b0 6b 9b 1e  19 5d 13 d8   f4 a7 99 5c  45 53 ac 05",
                    [0256] = "6b d2 37 8e  c3 41 c9 a4   2f 37 ba 79  f8 8a 32 ff",
                    [0496] = "e7 0b ce 1d  f7 64 5a db   5d 2c 41 30  21 5c 35 22",
                    [0512] = "9a 57 30 c7  fc b4 c9 af   51 ff da 89  c7 f1 ad 22",
                    [0752] = "04 85 05 5f  d4 f6 f0 d9   63 ef 5a b9  a5 47 69 82",
                    [0768] = "59 1f c6 6b  cd a1 0e 45   2b 03 d4 55  1f 6b 62 ac",
        ...
        public void RC4_Vector7()
        {
            Test("0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "cf a4 5c 9f  7e 71 4b 54   bd fa 80 02  7c b1 43 80",
                    [0240] = "11 4a e3 44  de d7 1b 35   f2 e6 0f eb  ad 72 7f d8",
                    [0256] = "02 e1 e7 05  6b 0f 62 39   00 49 64 22  94 3e 97 b6",
                    [0496] = "91 cb 93 c7  87 96 4e 10   d9 52 7d 99  9c 6f 93 6b",
                    [0512] = "49 b1 8b 42  f8 e8 36 7c   be b5 ef 10  4b a1 c7 cd",
                    [0752] = "87 08 4b 3b  a7 00 ba de   95 56 10 67  27 45 b3 74",
                    [0768] = "e7 a7 b9 e9  ec 54 0d 5f   f4 3b db 12  79 2d 1b 35",
        ...
        public void RC4_Vector8()
        {
            Test("833222772a",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "20 f0 60 c2  f2 e5 12 65   01 d3 d4 fe  a1 0d 5f c0",
                    [0240] = "fa a1 48 e9  90 46 18 1f   ec 6b 20 85  f3 b2 0e d9",
                    [0256] = "f0 da f5 ba  b3 d5 96 83   98 57 84 6f  73 fb fe 5a",
                    [0496] = "1c 7e 2f c4  63 92 32 fe   29 75 84 b2  96 99 6b c8",
                    [0512] = "3d b9 b2 49  40 6c c8 ed   ff ac 55 cc  d3 22 ba 12",
                    [0752] = "e4 f9 f7 e0  06 61 54 bb   d1 25 b7 45  56 9b c8 97",
                    [0768] = "75 d5 ef 26  2b 44 c4 1a   9c f6 3a e1  45 68 e1 b9",
        ...
        public void RC4_Vector9()
        {
            Test("1910833222772a",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "7a e6 27 41  0c 9a 2b e6   93 df 5b b7  48 5a 63 e3",
                    [0240] = "3f 09 31 aa  03 de fb 30   0f 06 01 03  82 6f 2a 64",
                    [0256] = "be aa 9e c8  d5 9b b6 81   29 f3 02 7c  96 36 11 81",
                    [0496] = "74 e0 4d b4  6d 28 64 8d   7d ee 8a 00  64 b0 6c fe",
                    [0512] = "9b 5e 81 c6  2f e0 23 c5   5b e4 2f 87  bb f9 32 b8",
                    [0752] = "ce 17 8f c1  82 6e fe cb   c1 82 f5 79  99 a4 61 40",
                    [0768] = "8b df 55 cd  55 06 1c 06   db a6 be 11  de 4a 57 8a",
        ...
        public void RC4_Vector10()
        {
            Test("641910833222772a",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "46 10 1a 6d  ab 43 11 5d   6c 52 2b 4f  e9 36 04 a9",
                    [0240] = "cb e1 ff f2  1c 96 f3 ee   f6 1e 8f e0  54 2c bd f0",
                    [0256] = "34 79 38 bf  fa 40 09 c5   12 cf b4 03  4b 0d d1 a7",
                    [0496] = "78 67 a7 86  d0 0a 71 47   90 4d 76 dd  f1 e5 20 e3",
                    [0512] = "8d 3e 9e 1c  ae fc cc b3   fb f8 d1 8f  64 12 0b 32",
                    [0752] = "94 23 37 f8  fd 76 f0 fa   e8 c5 2d 79  54 81 06 72",
                    [0768] = "b8 54 8c 10  f5 16 67 f6   e6 0e 18 2f  a1 9b 30 f7",
        ...
        public void RC4_Vector11()
        {
            Test("8b37641910833222772a",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "bb 75 90 10  c2 96 58 f2   c7 2d 93 a2  d1 6d 29 30",
                    [0240] = "b9 01 e8 03  6e d1 c3 83   cd 3c 4c 4d  d0 a6 ab 05",
                    [0256] = "3d 25 ce 49  22 92 4c 55   f0 64 94 33  53 d7 8a 6c",
                    [0496] = "12 c1 aa 44  bb f8 7e 75   e6 11 f6 9b  2c 38 f4 9b",
                    [0512] = "28 f2 b3 43  4b 65 c0 98   77 47 00 44  c6 ea 17 0d",
                    [0752] = "bd 9e f8 22  de 52 88 19   61 34 cf 8a  f7 83 93 04",
                    [0768] = "67 55 9c 23  f0 52 15 84   70 a2 96 f7  25 73 5a 32",
        ...
        public void RC4_Vector12()
        {
            Test("ebb46227c6cc8b37641910833222772a",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "c3 66 fd ea  cf 9c a8 04   36 be 7c 35  84 24 d2 0b",
                    [0240] = "b3 39 4a 40  aa bf 75 cb   a4 22 82 ef  25 a0 05 9f",
                    [0256] = "48 47 d8 1d  a4 94 2d bc   24 9d ef c4  8c 92 2b 9f",
                    [0496] = "08 12 8c 46  9f 27 53 42   ad da 20 2b  2b 58 da 95",
                    [0512] = "97 0d ac ef  40 ad 98 72   3b ac 5d 69  55 b8 17 61",
                    [0752] = "3c b8 99 93  b0 7b 0c ed   93 de 13 d2  a1 10 13 ac",
                    [0768] = "ef 2d 67 6f  15 45 c2 c1   3d c6 80 a0  2f 4a db fe",
        ...
        public void RC4_Vector13()
        {
            Test("c109163908ebe51debb46227c6cc8b37641910833222772a",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "c1 35 ee e2  37 a8 54 65   ff 97 dc 03  92 4f 45 ce",
                    [0240] = "cf cc 92 2f  b4 a1 4a b4   5d 61 75 aa  bb f2 d2 01",
                    [0256] = "83 7b 87 e2  a4 46 ad 0e   f7 98 ac d0  2b 94 12 4f",
                    [0496] = "17 a6 db d6  64 92 6a 06   36 b3 f4 c3  7a 4f 46 94",
                    [0512] = "4a 5f 9f 26  ae ee d4 d4   a2 5f 63 2d  30 52 33 d9",
                    [0752] = "80 a3 d0 1e  f0 0c 8e 9a   42 09 c1 7f  4e eb 35 8c",
                    [0768] = "d1 5e 7d 5f  fa aa bc 02   07 bf 20 0a  11 77 93 a2",
        ...
        public void RC4_Vector14()
        {
            Test("1ada31d5cf688221c109163908ebe51debb46227c6cc8b37641910833222772a",
                new Dictionary<int, string>
                {
                    ...
                    [0016] = "c8 44 6f 8f  77 ab f7 37   68 53 53 eb  89 a1 c9 eb",
                    [0240] = "af 3e 30 f9  c0 95 04 59   38 15 15 75  c3 fb 90 98",
                    [0256] = "f8 cb 62 74  db 99 b8 0b   1d 20 12 a9  8e d4 8f 0e",
                    [0496] = "25 c3 00 5a  1c b8 5d e0   76 25 98 39  ab 71 98 ab",
                    [0512] = "9d cb c1 83  e8 cb 99 4b   72 7b 75 be  31 80 76 9c",
                    [0752] = "a1 d3 07 8d  fa 91 69 50   3e d9 d4 49  1d ee 4e b2",
                    [0768] = "85 14 a5 49  58 58 09 6f   59 6e 4b cd  66 b1 06 65",
        ...
        private static void Test(string keystr, Dictionary<int, string> resultstr)
        {
            byte[] key = BitHelper.HexToBytes(keystr);

            int max = resultstr.Keys.Max();

            var rc4 = new RC4(key.Length);
            var stream = rc4.InitKeyStream(key, null, 0);

            byte[] buffer = new byte[16];
            for (int i = 0; i < max / 16; i++)
            {
                stream.Read(buffer, 0, 16);
                if (resultstr.ContainsKey(i * 16))
                {
                    byte[] bytes = BitHelper.HexToBytes(resultstr[i * 16].Replace(" ", ""));
                    Assert.IsTrue(ByteArray.Equals(bytes, buffer));
                }
            }
        }
    }
