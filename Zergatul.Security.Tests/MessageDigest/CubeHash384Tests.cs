...
{
    [TestClass]
    public class CubeHash384Tests : NISTMDTestWithData
    {
        ...
        protected override string Name => MessageDigests.CubeHash384;
        ...
        public void BasicTest()
        {
            foreach (var provider in Providers)
                using (var md = provider.GetMessageDigest(MessageDigests.CubeHash384))
                {
