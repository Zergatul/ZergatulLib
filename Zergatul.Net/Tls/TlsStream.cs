    ...
    public class TlsStream : Stream
    {
        ...
        private HandshakeMessage GenerateClientHello()
        {
            return new HandshakeMessage(new ClientHello
            {
                ...
                Random = _secParams.ClientRandom.ToArray(),
        ...
        private void OnServerHello(ServerHello message)
        {
            ...
            SelectedCipher = CipherSuite.Resolve(message.CipherSuite, _secParams, Role, _random);
        ...
        private void OnClientFinished(Finished message, bool validate)
        {
            ...
            if (validate)
            {
                var verifyData1 = SelectedCipher.GetFinishedVerifyData(new ByteArray(_clientFinishedHandshakeData), Role.Client).ToArray();
