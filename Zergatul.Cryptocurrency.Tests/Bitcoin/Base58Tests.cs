...
namespace Zergatul.Cryptocurrency.Tests.Bitcoin
{
    ...
    public class Base58Tests
    {
        ...
        {
            Assert.IsTrue(Base58Encoding.Encode(0, new byte[20]) == "1111111111111111111114oLvT2");
            Assert.IsTrue(ByteArray.Equals(new byte[21], Base58Encoding.Decode("1111111111111111111114oLvT2")));

            Assert.IsTrue(Base58Encoding.Encode(0, BitHelper.HexToBytes("0000000000000000000000000000000000000001")) == "11111111111111111111BZbvjr");
