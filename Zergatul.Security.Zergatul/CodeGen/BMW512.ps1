...
$csharpcode = @'
public static long Mult(ulong a, ulong b)
{
...
function s0($x)
{
    return "($x >> 1) ^ ($x << 3) ^ RotateLeft($x, 4) ^ RotateLeft($x, 37)"
}

function s1($x)
{
    return "($x >> 1) ^ ($x << 2) ^ RotateLeft($x, 13) ^ RotateLeft($x, 43)"
}

function s2($x)
{
    return "($x >> 2) ^ ($x << 1) ^ RotateLeft($x, 19) ^ RotateLeft($x, 53)"
}

function s3($x)
{
    return "($x >> 2) ^ ($x << 2) ^ RotateLeft($x, 28) ^ RotateLeft($x, 59)"
}
...
function r1($x)
{
    return "RotateLeft($x, 5)"
}

function r2($x)
{
    return "RotateLeft($x, 11)"
}
...
function r5($x)
{
    return "RotateLeft($x, 37)"
}

function r6($x)
{
    return "RotateLeft($x, 43)"
}

function r7($x)
{
    return "RotateLeft($x, 53)"
}
...
function Expand1
{
    ...
    $mult = [Lul.Helper]::Mult($j, 0x0555555555555555)
    $mp = "RotateLeft(m$(hex($j % 16)), $($j +  1 - 16)) + RotateLeft(m$(hex(($j + 3) % 16)), $($j +  4 - 16)) - RotateLeft(m$(hex(($j + 10) % 16)), $($j +  11 - 16)) + 0x$((hex($mult, 16)).ToUpper())"
...
function Expand2
{
    ...
    $mult = [Lul.Helper]::Mult($j, 0x0555555555555555)
    $mp = "RotateLeft(m$(hex($j % 16)), $(1 + ($j +  2 - 18) % 16)) + RotateLeft(m$(hex(($j + 3) % 16)), $(1 + ($j +  5 - 18) % 16)) - RotateLeft(m$(hex(($j + 10) % 16)), $(1 + ($j +  12 - 18) % 16)) + 0x$((hex($mult, 16)).ToUpper())"
...
function F0()
{
    Write-Output "ulong q00 = (m5 ^ h5) - (m7 ^ h7) + (ma ^ ha) + (md ^ hd) + (me ^ he);"
    Write-Output "q00 = ($(s0('q00'))) + h1;"
    Write-Output "ulong q01 = (m6 ^ h6) - (m8 ^ h8) + (mb ^ hb) + (me ^ he) - (mf ^ hf);"
    Write-Output "q01 = ($(s1('q01'))) + h2;"
    Write-Output "ulong q02 = (m0 ^ h0) + (m7 ^ h7) + (m9 ^ h9) - (mc ^ hc) + (mf ^ hf);"
    Write-Output "q02 = ($(s2('q02'))) + h3;"
    Write-Output "ulong q03 = (m0 ^ h0) - (m1 ^ h1) + (m8 ^ h8) - (ma ^ ha) + (md ^ hd);"
    Write-Output "q03 = ($(s3('q03'))) + h4;"
    Write-Output "ulong q04 = (m1 ^ h1) + (m2 ^ h2) + (m9 ^ h9) - (mb ^ hb) - (me ^ he);"
    Write-Output "q04 = ($(s4('q04'))) + h5;"
    Write-Output "ulong q05 = (m3 ^ h3) - (m2 ^ h2) + (ma ^ ha) - (mc ^ hc) + (mf ^ hf);"
    Write-Output "q05 = ($(s0('q05'))) + h6;"
    Write-Output "ulong q06 = (m4 ^ h4) - (m0 ^ h0) - (m3 ^ h3) - (mb ^ hb) + (md ^ hd);"
    Write-Output "q06 = ($(s1('q06'))) + h7;"
    Write-Output "ulong q07 = (m1 ^ h1) - (m4 ^ h4) - (m5 ^ h5) - (mc ^ hc) - (me ^ he);"
    Write-Output "q07 = ($(s2('q07'))) + h8;"
    Write-Output "ulong q08 = (m2 ^ h2) - (m5 ^ h5) - (m6 ^ h6) + (md ^ hd) - (mf ^ hf);"
    Write-Output "q08 = ($(s3('q08'))) + h9;"
    Write-Output "ulong q09 = (m0 ^ h0) - (m3 ^ h3) + (m6 ^ h6) - (m7 ^ h7) + (me ^ he);"
    Write-Output "q09 = ($(s4('q09'))) + ha;"
    Write-Output "ulong q0a = (m8 ^ h8) - (m1 ^ h1) - (m4 ^ h4) - (m7 ^ h7) + (mf ^ hf);"
    Write-Output "q0a = ($(s0('q0a'))) + hb;"
    Write-Output "ulong q0b = (m8 ^ h8) - (m0 ^ h0) - (m2 ^ h2) - (m5 ^ h5) + (m9 ^ h9);"
    Write-Output "q0b = ($(s1('q0b'))) + hc;"
    Write-Output "ulong q0c = (m1 ^ h1) + (m3 ^ h3) - (m6 ^ h6) - (m9 ^ h9) + (ma ^ ha);"
    Write-Output "q0c = ($(s2('q0c'))) + hd;"
    Write-Output "ulong q0d = (m2 ^ h2) + (m4 ^ h4) + (m7 ^ h7) + (ma ^ ha) + (mb ^ hb);"
    Write-Output "q0d = ($(s3('q0d'))) + he;"
    Write-Output "ulong q0e = (m3 ^ h3) - (m5 ^ h5) + (m8 ^ h8) - (mb ^ hb) - (mc ^ hc);"
    Write-Output "q0e = ($(s4('q0e'))) + hf;"
    Write-Output "ulong q0f = (mc ^ hc) - (m4 ^ h4) - (m6 ^ h6) - (m9 ^ h9) + (md ^ hd);"
...
function F2()
{
    Write-Output "ulong xl = q10 ^ q11 ^ q12 ^ q13 ^ q14 ^ q15 ^ q16 ^ q17;"
    Write-Output "ulong xh = q18 ^ q19 ^ q1a ^ q1b ^ q1c ^ q1d ^ q1e ^ q1f ^ xl;"
