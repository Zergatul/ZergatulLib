...
namespace Zergatul.Math.Tests
{
    ...
    public class BigIntegerTests
    {
        ...
        #region CompareTo Int64

        [TestMethod]
        public void CompareToInt64_1()
        {
            Assert.IsTrue(BigInteger.Zero.CompareTo(0L) == 0);
            Assert.IsTrue(BigInteger.Zero.CompareTo(1L) == -1);
            Assert.IsTrue(BigInteger.Zero.CompareTo(-1L) == 1);

            Assert.IsTrue(BigInteger.One.CompareTo(0L) == 1);
            Assert.IsTrue(BigInteger.One.CompareTo(1L) == 0);
            Assert.IsTrue(BigInteger.One.CompareTo(-1L) == 1);

            Assert.IsTrue(BigInteger.Parse("-1").CompareTo(0L) == -1);
            Assert.IsTrue(BigInteger.Parse("-1").CompareTo(1L) == -1);
            Assert.IsTrue(BigInteger.Parse("-1").CompareTo(-1L) == 0);
        }

        [TestMethod]
        public void CompareToInt64_2()
        {
            Assert.IsTrue(BigInteger.Parse("2147483647").CompareTo(2147483646L) == 1);
            Assert.IsTrue(BigInteger.Parse("2147483647").CompareTo(2147483647L) == 0);
            Assert.IsTrue(BigInteger.Parse("2147483647").CompareTo(2147483648L) == -1);
            Assert.IsTrue(BigInteger.Parse("2147483648").CompareTo(2147483647L) == 1);
            Assert.IsTrue(BigInteger.Parse("2147483648").CompareTo(2147483648L) == 0);
            Assert.IsTrue(BigInteger.Parse("2147483648").CompareTo(2147483649L) == -1);
            Assert.IsTrue(BigInteger.Parse("2147483647").CompareTo(-2147483646L) == 1);
            Assert.IsTrue(BigInteger.Parse("2147483647").CompareTo(-2147483647L) == 1);
            Assert.IsTrue(BigInteger.Parse("2147483647").CompareTo(-2147483648L) == 1);
            Assert.IsTrue(BigInteger.Parse("2147483648").CompareTo(-2147483647L) == 1);
            Assert.IsTrue(BigInteger.Parse("2147483648").CompareTo(-2147483648L) == 1);
            Assert.IsTrue(BigInteger.Parse("2147483648").CompareTo(-2147483649L) == 1);
            Assert.IsTrue(BigInteger.Parse("-2147483647").CompareTo(-2147483646L) == -1);
            Assert.IsTrue(BigInteger.Parse("-2147483647").CompareTo(-2147483647L) == 0);
            Assert.IsTrue(BigInteger.Parse("-2147483647").CompareTo(-2147483648L) == 1);
            ...
            Assert.IsTrue(BigInteger.Parse("4294967295").CompareTo(4294967294L) == 1);
            Assert.IsTrue(BigInteger.Parse("4294967295").CompareTo(4294967295L) == 0);
            Assert.IsTrue(BigInteger.Parse("4294967295").CompareTo(4294967296L) == -1);
            Assert.IsTrue(BigInteger.Parse("4294967296").CompareTo(4294967295L) == 1);
            Assert.IsTrue(BigInteger.Parse("4294967296").CompareTo(4294967296L) == 0);
            Assert.IsTrue(BigInteger.Parse("4294967296").CompareTo(4294967297L) == -1);
            Assert.IsTrue(BigInteger.Parse("4294967295").CompareTo(-4294967294L) == 1);
            Assert.IsTrue(BigInteger.Parse("4294967295").CompareTo(-4294967295L) == 1);
            Assert.IsTrue(BigInteger.Parse("4294967295").CompareTo(-4294967296L) == 1);
            Assert.IsTrue(BigInteger.Parse("4294967296").CompareTo(-4294967295L) == 1);
            Assert.IsTrue(BigInteger.Parse("4294967296").CompareTo(-4294967296L) == 1);
            Assert.IsTrue(BigInteger.Parse("4294967296").CompareTo(-4294967297L) == 1);
            Assert.IsTrue(BigInteger.Parse("-4294967295").CompareTo(-4294967294L) == -1);
            Assert.IsTrue(BigInteger.Parse("-4294967295").CompareTo(-4294967295L) == 0);
            Assert.IsTrue(BigInteger.Parse("-4294967295").CompareTo(-4294967296L) == 1);
        ...
        [TestMethod]
        public void CompareToInt64_3()
        {
            Assert.IsTrue(BigInteger.Parse("9223372036854775807").CompareTo(9223372036854775806L) == 1);
            Assert.IsTrue(BigInteger.Parse("9223372036854775807").CompareTo(9223372036854775807L) == 0);
            Assert.IsTrue(BigInteger.Parse("9223372036854775808").CompareTo(9223372036854775806L) == 1);
            Assert.IsTrue(BigInteger.Parse("9223372036854775808").CompareTo(9223372036854775807L) == 1);
            Assert.IsTrue(BigInteger.Parse("9223372036854775807").CompareTo(-9223372036854775806L) == 1);
            Assert.IsTrue(BigInteger.Parse("9223372036854775807").CompareTo(-9223372036854775807L) == 1);
            Assert.IsTrue(BigInteger.Parse("9223372036854775808").CompareTo(-9223372036854775806L) == 1);
            Assert.IsTrue(BigInteger.Parse("9223372036854775808").CompareTo(-9223372036854775807L) == 1);
            Assert.IsTrue(BigInteger.Parse("-9223372036854775807").CompareTo(-9223372036854775806L) == -1);
            Assert.IsTrue(BigInteger.Parse("-9223372036854775807").CompareTo(-9223372036854775807L) == 0);
        ...
        [TestMethod]
        public void CompareToInt64_4()
        {
            Assert.IsTrue(BigInteger.Parse("9123372036854775807").CompareTo(9223372036854775807L) == -1);
            Assert.IsTrue(BigInteger.Parse("9223372036854775807").CompareTo(9123372036854775807L) == 1);
        }
